<x-layout>
  <div class="grid grid-cols-2 gap-4 mb-5">
    <div class="flex items-center border-r">
      <img src={{asset('images/about_page_image.webp')}} class="h-3/5 mx-auto">
    </div>
    <div class="flex flex-col justify-center w-2/3 py-10 space-y-2 mx-auto">
      <h1 class="text-5xl font-medium font-gupter">Hello there! I'm Sersei,</h1>
      <h4 class="text-xl font-normal">A writing enthusiast & blogger</h4>
      <br>
      <div class="space-y-4 text-md font-light text-justify">
